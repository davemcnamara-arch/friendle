...
-- ==========================================
-- Note: In Supabase, pg_cron should already be enabled by default.
-- If you get a "dependent privileges exist" error, it means pg_cron is already installed.
-- You can safely skip this step and proceed to the next section.
...
-- ==========================================
-- STEP 2: Remove existing jobs (cleanup)
-- ==========================================
...
-- ==========================================
-- STEP 3: Schedule the hourly cron job
-- ==========================================
...
-- - This error occurs when pg_cron is already installed
-- - Solution: The migration now checks if pg_cron exists before creating it
-- - You can safely re-run this migration
--
-- To verify pg_cron is installed, run:
